...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/styleLogin.css') }}"> <!-- Jika ada CSS -->
    <script src="{{ asset('assets/js/indexLogin.js') }}" defer></script>
...
<body>
    ...
    <nav class="navbar desktop flex items-center justify-center gap-[156px] p-[22px] sticky top-0 z-50 transition-all duration-300 ease-in-out hidden lg:flex mx-auto max-w-screen-lg shadow-md rounded-lg" id="navbar-desktop">
      <!-- Logo -->
      <a class="logoNav bg-[url('/assets/LogoDaisekoi.png')] bg-center bg-cover w-[117px] h-[72.668px] flex-shrink-0 relative transform transition-transform hover:translate-y-[5%]" href="/"></a>
  </nav>
  <nav class="navbar mobile flex flex-col justify-center items-center w-full p-4 sticky-lg-top top-0 z-2000 lg:hidden" id="navbar-mobile">
    <div class="flex w-full justify-between items-center">
        <!-- Logo -->
        <a class="logoNav bg-[url('/assets/LogoDaisekoi.png')] bg-center bg-cover max-w-md max-h-md md:max-w-lg md:max-h-lg lg:max-w-xl lg:max-h-xl xl:max-w-2xl xl:max-h-2xl w-[17vw] h-[10.5vw]" href="/"></a>
  ...
  <div class="flex flex-col lg:flex-row lg:gap-auto justify-between items-center w-full max-w-[1180px] h-auto mx-auto px-[20px] lg:px-[40px] py-[15px]">
    ...
    <div class="relative w-full lg:w-[50%] h-[300px] lg:h-[510px] flex items-center justify-center mb-6 lg:mb-0">
        <div class="w-full h-full max-w-[300px] lg:max-w-none bg-cover bg-center" 
             style="background-image: url('/assets/HomePage.png');"></div>
    </div>
    ...
    <form class="form w-full lg:w-[40%] h-auto lg:h-[444px] bg-[#a3ddee] rounded-lg shadow-lg flex flex-col justify-center items-center gap-8 px-[20px] py-6 lg:px-[40px] lg:py-8" id="loginForm">
        @csrf
        <!-- Judul -->
        ...
        <div class="relative w-full">
          <label for="username">Username</label>
            <input type="text" 
                   class="username w-full h-[48px] lg:h-[54px] border border-black rounded-lg px-[25px] text-[14px] lg:text-[15px] placeholder:text-black/25" 
    ...
    <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 1200 1200" fill="currentColor" class="hidden">
        ...
        <!-- Tombol Selanjutnya -->
        <button class="submit-btn w-full h-[54px] lg:h-[68px] bg-[#c69c6d] text-[#f5f5dc] text-xl lg:text-2xl font-bold rounded-lg">
            Login
        </button>
      </form>
